...
const ServiceShowcase = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-emerald-600 mb-8">Vitrine de Serviços</h1>

      {/* Seção: Quem quer divulgar serviços */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-emerald-600 mb-6">Quer divulgar seu serviço?</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-emerald-600 mb-6">Quer solicitar um serviço?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
