-- Arquivo: create_top_afiliados_table.sql
-- Descrição: Cria uma tabela para gerenciar os Top Afiliados da plataforma
...
CREATE UNIQUE INDEX top_afiliados_posicao_idx ON public.top_afiliados (posicao) 
WHERE status = 'ativo';

-- Garantir que Instagram seja único
CREATE UNIQUE INDEX top_afiliados_instagram_idx ON public.top_afiliados (instagram);
...
-- Inserir dados iniciais dos top afiliados existentes
...
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 1);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Pedro Costa', '@pedrocosta.oficial', 'https://i.pravatar.cc/150?img=3', 1050, 105000.00, 'R$ 105.000,00', 3, true
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 2);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Ana Oliveira', '@anaoliveira.digital', 'https://i.pravatar.cc/150?img=4', 980, 98000.00, 'R$ 98.000,00', 4, true
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 3);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Lucas Mendes', '@lucasmendes.mkt', 'https://i.pravatar.cc/150?img=5', 920, 92000.00, 'R$ 92.000,00', 5, true
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 4);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Carla Souza', '@carlasouza.afiliada', 'https://i.pravatar.cc/150?img=6', 850, 85000.00, 'R$ 85.000,00', 6, false
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 5);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Rafael Lima', '@rafaellima.digital', 'https://i.pravatar.cc/150?img=7', 820, 82000.00, 'R$ 82.000,00', 7, false
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 6);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Julia Ferreira', '@juliaferreira.mkt', 'https://i.pravatar.cc/150?img=8', 780, 78000.00, 'R$ 78.000,00', 8, false
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 7);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Bruno Santos', '@brunosantos.oficial', 'https://i.pravatar.cc/150?img=9', 750, 75000.00, 'R$ 75.000,00', 9, false
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 8);

INSERT INTO public.top_afiliados (nome, instagram, profile_image, vendas, comissao, comissao_formatada, posicao, is_top5)
SELECT 'Mariana Costa', '@marianacosta.digital', 'https://i.pravatar.cc/150?img=10', 720, 72000.00, 'R$ 72.000,00', 10, false
WHERE EXISTS (SELECT 1 FROM public.top_afiliados WHERE posicao = 9); 