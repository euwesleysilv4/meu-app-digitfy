-- Script para adicionar política específica de inserção para administradores
-- Executar este script no SQL Editor do Supabase após o fix_policy_recursion.sql
