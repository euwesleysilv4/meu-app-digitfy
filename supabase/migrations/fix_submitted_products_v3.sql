...
SELECT COUNT(*) FROM submitted_products;

-- Informativo final
SELECT 'Tabela submitted_products foi configurada com sucesso. Usuários agora podem enviar seus produtos para aprovação.' AS mensagem; 